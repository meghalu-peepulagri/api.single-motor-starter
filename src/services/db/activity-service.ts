...
export class ActivityService {
   ...
   */
  static async writeMotorAddedLog(userId: number, motorId: number, data: { name: string | null; hp: number | string; location_id: number | null }, trx?: any, message?: string) {
   ...
   */
  static async writeMotorUpdatedLog(userId: number, motorId: number, oldData: { name: string | null; hp: string | null; state?: number | null; mode?: string | null }, newData: { name?: string | null; hp?: string | null; state?: number | null; mode?: string | null }, trx?: any, deviceId?: number) {
   ...
   */
  static async writeMotorDeletedLog(userId: number, motorId: number, trx?: any, deviceId?: number, message?: string) {
   ...
   */
  static async writeMotorAckLogs(userId: number, motorId: number, oldData: { state?: number; mode?: string }, newData: { state?: number; mode?: string }, action: "MOTOR_CONTROL_ACK" | "MOTOR_MODE_ACK", trx?: any, deviceId?: number) {
   ...
   */
  static async writeStarterAssignedLog(userId: number, starterId: number, data: { user_id: number; location_id?: number | null; motor_name?: string }, trx?: Transaction, message?: string) {
    const log = prepareActionLog({
      userId,
   ...
   */
  static async writeLocationReplacedLog(userId: number, starterId: number, oldData: { location_id: number | null }, newData: { location_id: number; motor_id: number }, trx?: Transaction, message?: string) {
    const log = prepareActionLog({
      userId,
