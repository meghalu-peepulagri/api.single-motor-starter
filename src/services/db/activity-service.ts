...
export class ActivityService {
  ...
  static async writeMotorAssignedLog(userId: number, motorId: number, starterId: number, motorReference: string, trx?: any) {
    const log = prepareActionLog({
      userId,
  ...
  static async writeMotorDetachedLog(userId: number, motorId: number, starterId: number, trx?: any) {
    const log = prepareActionLog({
      userId,
  ...
  static async writeMotorReplacedLog(userId: number, oldMotorId: number, newMotorId: number, starterId: number, motorReference: string, trx?: any) {
    const log = prepareActionLog({
      userId,
