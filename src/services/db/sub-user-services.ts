...
export async function assignSubUserPermissions(subUserId: number, parentId: number, keys: string[]): Promise<{ old: string[]; new: string[] } | null> {
