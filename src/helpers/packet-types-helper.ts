import type { PayloadVersion } from "./payload-version-helper.js";
...
export function requestTypesFor(version: PayloadVersion) {
  return version === "1.0" ? REQUEST_TYPES_V1 : REQUEST_TYPES_V2;
}

export function ackTypesFor(version: PayloadVersion) {
...
export function findTopicACKByType(payload: any, version: PayloadVersion = "1.0") {
...
export function getMotorControlStatusDescription(code: number): string {
  switch (code) {
...
export function isMotorControlStateCode(code: number): code is 0 | 1 {
...
export function getModeControlStatusDescription(code: number): string {
  switch (code) {
...
const MODE_CONTROL_CODE_TO_MODE: Record<number, "MANUAL" | "AUTO" | "SCHEDULE"> = {
