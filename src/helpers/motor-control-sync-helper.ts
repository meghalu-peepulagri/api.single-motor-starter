...
import { motorControlPendingAckMap, type MotorControlAckResult } from "./ack-tracker-hepler.js";
import { buildMotorControlPayload, type MotorControlTarget } from "./motor-control-payload-helper.js";
...
function waitForMotorControlAck(publishedKey: string, sequenceNumber: number, timeoutMs: number): Promise<MotorControlAckResult> {
 ...
 */
export async function sendMotorControlCommand(
  starter: StarterBox,
  targets: MotorControlTarget[],
): Promise<MotorControlAckResult> {
