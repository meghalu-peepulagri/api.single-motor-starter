...
async function saveWithDeadlockRetry(prepared: any, validMac: any): Promise<void> {
...
async function processMultiMotorLiveData(parsedMessage: any, groupKey: string, rawGroupData: any, validMac: any): Promise<void> {
