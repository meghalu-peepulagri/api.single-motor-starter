...
export function prepareLiveDataPayload(validatedData: any, starterData: any, motor?: { id: number | null; state?: number; mode?: string; [key: string]: any }) {
  ...
  return {
    ...
    motor_id: (resolvedMotor.id ?? null) as number,
