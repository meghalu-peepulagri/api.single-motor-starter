...
import { starterDispatch, type NewStarterDispatch, type StarterDispatchTable } from "../database/schemas/starter-dispatch.js";
...
export async function requireActiveDispatch(dispatchId: number) {
...
export async function requireActiveStarterBoxIfAny(starterId: number | null | undefined) {
...
export async function ensureUniqueSimNoForUpdate(simNo: string, dispatchId: number) {
...
export function applyOptionalDispatchFields(
  dispatchUpdate: any,
  rawPayload: any,
  validDispatchReq: ValidatedAddStarterDispatch,
) {
