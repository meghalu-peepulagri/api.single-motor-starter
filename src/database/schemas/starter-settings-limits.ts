...
export type StarterSettingsLimits = typeof starterSettingsLimits.$inferSelect;
export type NewStarterSettingsLimits = typeof starterSettingsLimits.$inferInsert;
export type StarterSettingsLimitsTable = typeof starterSettingsLimits;
