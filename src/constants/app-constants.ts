...
export const USER_DETAILS_WITH_LOCATIONS_FETCHED = "User details with locations fetched successfully";
...
export const REPLACE_DEVICE_NOT_ASSIGNED = "Only devices assigned to a user can be replaced. For an unassigned device, delete it and add the new device instead.";
...
export const REPLACE_PCB_MOTOR_TYPE_MISMATCH = "The replacement device is of a different motor type (single/dual) and cannot be used here.";
export const REPLACE_SPARE_DEVICE_ASSIGNED = "This device is assigned to a user and cannot be used as a replacement.";
export const REPLACE_SPARE_DEVICE_NOT_DEPLOYED = "The replacement device must be in Deployed state.";
export const REPLACE_SPARE_DEVICE_NOT_FOUND = "No device found with this Starter Number and PCB Number.";
export const REPLACE_SPARE_NUMBERS_MISMATCH = "Starter Number and PCB Number do not belong to the same device.";
export const REPLACE_PCB_NOT_FOUND = "No device found with this PCB Number.";
...
// Motor schedule 
export const SCHEDULE_TYPES = ["TIME_BASED", "CYCLIC"] as const;
...
export const SCHEDULE_STATUS = ["PENDING", "SCHEDULED", "RUNNING", "STOPPED", "COMPLETED", "FAILED", "CANCELLED", "DELETED", "RESTARTED", "WAITING_NEXT_CYCLE"] as const;
...
export const SCHEDULE_REPUBLISHED = "Schedule republished to device successfully";
