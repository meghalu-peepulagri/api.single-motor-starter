...
function parseArgs(): LogViewerOptions {
...
function filterLogs(lines: string[], options: LogViewerOptions): string[] {
  let filtered = lines;
...
function viewLogs(options: LogViewerOptions): void {
  const logsDir = getLogsDir();
