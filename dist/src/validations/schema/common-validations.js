...
import { DEVICE_MIN_LEN, DEVICE_NAME_REQUIRED, DEVICE_NAME_STARTS_LETTER, EMAIL_REQUIRED, FIELD_NAME_INVALID, FIELD_NAME_MIN_LEN, FIELD_NAME_MUST_STRING, FIELD_NAME_REQUIRED, HP_MAX, HP_MIN, HP_REQUIRED, ID_INVALID, ID_NUMBER, INVALID_OTP, INVALID_OTP_LENGTH, INVALID_PHONE, INVALID_PHONE_NUMBER, INVALID_PHONE_NUMBER_VALID_LENGTH, LOCATION_NAME_INVALID, LOCATION_NAME_MIN_LEN, MAC_MIN_LEN, MAC_REQUIRED, MOTOR_MIN_LENGTH, MOTOR_NAME, MOTOR_NAME_STARTS_LETTER, MOTOR_REQUIRED, NAME_MIN_LENGTH, NAME_REQUIRED, OTP_REQUIRED, PASSWORD_MIN_LENGTH, PASSWORD_REQUIRED, PASSWORD_SHOULD_CONTAIN_NUMBER, PASSWORD_SHOULD_CONTAIN_UPPERCASE, PASSWORD_SPECIAL_CHAR, PCB_MIN_LEN, PCB_NUMBER_REQUIRED, PHONE_NUMBER_REQUIRED, SERIAL_NO_MIN_LEN, SERIAL_NO_REQUIRED, SMALL_LETTERS_NOT_ALLOWED, STARTER_NUMBER_MIN_LEN, STARTER_NUMBER_REQUIRED, TITLE_MUST_BE_STRING, TITLE_REQUIRED, USER_TYPE_INVALID, USER_TYPE_REQUIRED, VALID_MAIL, VALID_NAME } from "../../constants/app-constants.js";
...
const starterBoxTitleValidator = v.pipe(v.string(DEVICE_NAME_REQUIRED), v.transform(value => value.trim()), v.nonEmpty(DEVICE_NAME_REQUIRED), v.regex(/^[A-Z].*$/i, DEVICE_NAME_STARTS_LETTER), v.minLength(3, DEVICE_MIN_LEN));
