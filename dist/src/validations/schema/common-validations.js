...
const simNumberValidator = v.pipe(v.string(SIM_NUMBER_REQUIRED), v.trim(), v.nonEmpty(SIM_NUMBER_REQUIRED), v.regex(/^\d+$/, INVALID_SIM_NUMBER), v.regex(/^\d{1,40}$/, INVALID_SIM_NUMBER_VALID_LENGTH));
