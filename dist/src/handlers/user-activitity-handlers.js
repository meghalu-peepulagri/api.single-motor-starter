...
export class UserActivityHandlers {
    getUserActivities = async (c) => {
        try {
            ...
            const usersActivities = await getRecordsConditionally(userActivityLogs, whereQueryData, ["id", "user_id", "action", "old_data", "new_data"], orderQueryData);
