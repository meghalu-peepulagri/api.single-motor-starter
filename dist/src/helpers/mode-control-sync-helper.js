...
import { modeControlPendingAckMap } from "./ack-tracker-hepler.js";
import { buildModeControlPayload } from "./mode-control-payload-helper.js";
...
function waitForModeControlAck(publishedKey, sequenceNumber, timeoutMs) {
 ...
 */
export async function sendModeControlCommand(starter, targets) {
