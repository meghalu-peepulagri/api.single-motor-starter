...
export function cleanThreeNumberArray(arr) {
    const clean = [0, 0, 0];
...
export function validateG01(data) {
    const result = {
...
export function validateG02(data) {
    const result = {
        validated_payload: true,
        data: null
    };
...
export function validateG03(data) {
    const result = {
        validated_payload: true,
        data: null
    };
...
export function validateG04(data) {
    const result = {
        validated_payload: true,
        data: null
    };
