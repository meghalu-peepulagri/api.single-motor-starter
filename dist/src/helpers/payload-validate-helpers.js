...
const CONFIG = {
    ...
    G02: { required: ["pwr", "mode", "llv", "m_s", "amp"], array3: ["llv", "amp"] },
    G03: { required: ["pwr", "llv", "m_s"], array3: ["llv"] },
    G04: { required: ["pwr", "mode"], array3: [] },
};
export function validateAndExtractLiveData(payload) {
    ...
    const groupKey = Object.keys(CONFIG).find((k) => k in D && D[k] != null && typeof D[k] === "object") || null;
    const cleaned = {};
    if (!groupKey) {
