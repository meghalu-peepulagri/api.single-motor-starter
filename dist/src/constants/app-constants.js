...
export const DEVICE_ROLES = ["STANDALONE", "MASTER", "CHILD"];
export const REASSIGNMENT_STRATEGIES = ["ORPHAN", "REPARENT"];
...
export const REPLACE_MASTER_MODES = ["SWAP_CHILDREN", "MOVE_CHILDREN", "REPLACE_DEVICE"];
