...
export async function getAllDispatches(search, order_by, order_type) {
    ...
    const searchCondition = search
        ? or(ilike(starterDispatch.customer_name, `%${search}%`), ilike(starterDispatch.contact_number, `%${search}%`), ilike(starterDispatch.sim_no, `%${search}%`), ilike(starterDispatch.address, `%${search}%`), ilike(starterDispatch.location, `%${search}%`), ilike(starterDispatch.pcb_number, `%${search}%`), ilike(starterDispatch.box_serial_no, `%${search}%`))
        : undefined;
